...
/**
 * @title TestBNBToken
 * @dev Test BEP-20 token for BNB Testnet with public minting for faucet functionality
 * This is a testnet-only token - DO NOT use in production
 */
contract TestBNBToken is ERC20, Ownable {
    ...
    constructor(uint256 initialSupply)
        ERC20("Test BNB Payment Token", "tBNBP")
        Ownable(msg.sender)
    {
